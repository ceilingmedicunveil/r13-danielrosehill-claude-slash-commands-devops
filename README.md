...
### Derived from [danielrosehill/Claude-Slash-Commands](https://github.com/danielrosehill/Claude-Slash-Commands)
...
> **Adaptation of `danielrosehill/Claude-Slash-Commands` for DevOps & Cloud Infrastructure use cases.**
> Source focus: _slash commands, hooks, flat command listing_
...
```bash
# Clone this skill
cp -r . ~/.claude/skills/r00-danielrosehill-Claude-Slash-Commands--devops/

# Register in Claude Code
# In a Claude Code session:
/read ~/.claude/skills/r00-danielrosehill-Claude-Slash-Commands--devops/SKILL.md
```
...
**[danielrosehill/Claude-Slash-Commands](https://github.com/danielrosehill/Claude-Slash-Commands)**
which focuses on: _slash commands, hooks, flat command listing_.
